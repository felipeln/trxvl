    ...
    <nav className="pt-4 sm:flex sm:gap-4 sm:justify-between sm:items-center sm:h-20 sm:mx-7">
        <div className="relative hamburger-logo-wrapper sm:flex sm:items-center sm:w-min sm:justify-start">
          <div
            ...
            className="z-10 hamburger-menu w-6 h-6 bg-[url('/src/assets/top-menu/hamburger-menu.svg')] bg-no-repeat sm:hidden sm:invisible"
        ...
        <ul id="ul-menu"
          className="absolute z-10 mt-8 left-6 right-6 h-96 flex-col flex justify-evenly items-center gap-6  bg-slate-400/40 backdrop-blur-lg  rounded-3xl invisible
