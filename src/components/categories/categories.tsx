import { useEffect, useState, useRef,  MutableRefObject, ReactNode } from "react";
...
const Categories = () => {
  ...
  return(
      <section className="p-6 lg:absolute lg:top-[510px]  lg:z-10  lg:p-0 lg:px-120 lg:w-full ">
